...
function ClockLoader() {
  return (
    <>
      <style>{`
        .clock-wrap { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; background: radial-gradient(ellipse at center, rgba(41,42,45,1) 0%, rgba(0,0,0,1) 100%); }
