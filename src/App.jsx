...
const HOTSPOTS = {
   0: [
    ...
    { copy: 'moisesnevett@gmail.com', x: 5, y: 8, w: 20, h: 3, label: 'Copy Email', toast: 'Email copied', debug: false },
...
// Tip: tweak the two numbers (hotspot x y in px) so the arrow tip feels like the click point.
const CURSORS = {
...
// ------------ Loader component (based on your CSS effect) ---------------------
function LoaderBars() {
  return (
    <>
      <style>{`
